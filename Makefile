...
env:
	...
	@echo "export LUA_CPATH='./?.so;$(SRCDIR)/?.so;$(BUILDDIR)/$(CDIR)/?.so;$$(lua -e 'print(package.cpath)')'"
	@echo "export LUA_PATH='./?.lua;$(SRCDIR)/?.lua;$(BUILDDIR)/$(LDIR)/?.lua;$$(lua -e 'print(package.path)')'"
