...
route queries. All base values in an array tree have that same height. A raw hash
...
complete subtrees. Each becomes one array tree. A subtree inside the explicit
...
2. Decompose the remaining count into powers of two and place the corresponding
   partially filled array trees directly into empty levels.
...
- Fully explicit, fully repeated, and explicit-prefix/repeated-suffix array
