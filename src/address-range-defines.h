...
#define AR_SHADOW_STATE_LENGTH_DEF 0x20000         ///< Shadow length in bytes
...
#define AR_SHADOW_TLB_LENGTH_DEF 0x18000           ///< Shadow TLB length in bytes (3 sets x 4 contexts x 256 slots)
#define AR_PMAS_START_DEF 0x20000                  ///< PMA Array start address
