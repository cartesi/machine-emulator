...
#define AR_SHADOW_STATE_LENGTH_DEF 0x10000         ///< Shadow length in bytes
...
#define AR_SHADOW_TLB_LENGTH_DEF 0xC000            ///< Shadow TLB length in bytes (3 sets x 4 contexts x 128 slots)
