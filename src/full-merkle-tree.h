...
public:
    ...
    full_merkle_tree(int log2_root_size, int log2_leaf_size, int log2_word_size, i_hasher hasher);
...
private:
    ...
    void init_subtree(i_hasher &h, int index, int log2_size);
    ...
    mutable i_hasher m_hasher;        ///< Hasher object
