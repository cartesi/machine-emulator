...
private:
    ...
    void do_log_send_cmio_response(uint16_t reason, const unsigned char *data, uint64_t length,
        const_machine_hash_view revert_root_hash, const std::string &filename) override;
