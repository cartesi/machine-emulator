...
private:
    ...
    machine_hash do_verify_step(const_machine_hash_view root_hash_before, std::span<const unsigned char> log,
        uint64_t mcycle_count) const override;
    machine_hash do_verify_step_uarch(const_machine_hash_view root_hash_before, std::span<const unsigned char> log,
        uint64_t uarch_cycle_count) const override;
    machine_hash do_verify_reset_uarch(const_machine_hash_view root_hash_before,
        std::span<const unsigned char> log) const override;
