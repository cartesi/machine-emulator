...
enum MIX_RW_masks : uint64_t {
    ...
    MIP_W_MASK = MIP_SSIP_MASK | MIP_STIP_MASK | MIP_SEIP_MASK,
};

/// \brief hie & hip (hvip) read/write masks
enum HIX_RW_masks : uint64_t {
    HIX_W_MASK = MIP_VSEIP_MASK | MIP_VSTIP_MASK | MIP_VSSIP_MASK | MIP_SGEIP_MASK,
    HIX_R_MASK = MIP_VSEIP_MASK | MIP_VSTIP_MASK | MIP_VSSIP_MASK,
};
