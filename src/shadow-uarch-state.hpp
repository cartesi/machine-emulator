...
#ifndef SHADOW_UARCH_STATE_HPP
#define SHADOW_UARCH_STATE_HPP
...
static constexpr uint64_t shadow_uarch_state_get_what_address(shadow_uarch_state_what what) {
    return static_cast<uint64_t>(what);
}
