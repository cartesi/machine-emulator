...
#ifndef UARCH_STEP_HPP
#define UARCH_STEP_HPP
...
extern template UArchStepStatus uarch_step(uarch_replay_step_state_access<no_step_log_dumper> a);
extern template UArchStepStatus uarch_step(uarch_replay_step_state_access<step_log_dumper> a);
