...
#ifndef VIRTIO_P9FS_ADDRESS_RANGE_HPP
#define VIRTIO_P9FS_ADDRESS_RANGE_HPP
...
enum p9_error : uint32_t {
    ...
    P9_EDEADLOCK = P9_EDEADLK,  ///< Resource deadlock would occur
...
#endif // VIRTIO_P9FS_ADDRESS_RANGE_HPP
