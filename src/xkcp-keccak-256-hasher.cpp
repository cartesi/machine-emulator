...
// AVX512
HashReturn AVX512_Keccak_HashInitialize(Keccak_HashInstance *hashInstance, unsigned int rate, unsigned int capacity, unsigned int hashbitlen, unsigned char delimitedSuffix);
HashReturn AVX512_Keccak_HashUpdate(Keccak_HashInstance *hashInstance, const BitSequence *data, BitLength databitlen);
HashReturn AVX512_Keccak_HashFinal(Keccak_HashInstance *hashInstance, BitSequence *hashval);
#endif
}
