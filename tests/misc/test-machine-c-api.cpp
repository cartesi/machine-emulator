...
BOOST_FIXTURE_TEST_CASE_NOLINT(verify_step_uarch_null_filename_test, default_machine_fixture) {
    cm_error error_code = cm_verify_step_uarch(nullptr, nullptr, nullptr, 0, nullptr, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_INVALID_ARGUMENT);
...
BOOST_FIXTURE_TEST_CASE_NOLINT(verify_step_uarch_null_hash0_test, step_log_machine_fixture) {
    ...
    cm_hash hash1;
    error_code = cm_verify_step_uarch(nullptr, nullptr, filename.c_str(), 1, &hash1, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_INVALID_ARGUMENT);
...
BOOST_FIXTURE_TEST_CASE_NOLINT(verify_step_uarch_null_hash1_test, step_log_machine_fixture) {
    cm_hash hash0;
    ...
    // a NULL root_hash_after skips the check and the obtained hash is returned
    cm_hash obtained_root_hash;
    error_code = cm_verify_step_uarch(nullptr, &hash0, filename.c_str(), 1, nullptr, &obtained_root_hash);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
...
BOOST_FIXTURE_TEST_CASE_NOLINT(verify_step_uarch_null_filename_with_hashes_test, step_log_machine_fixture) {
    cm_hash hash0;
    cm_hash hash1;
    cm_error error_code = cm_verify_step_uarch(nullptr, &hash0, nullptr, 0, &hash1, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_INVALID_ARGUMENT);
...
BOOST_FIXTURE_TEST_CASE_NOLINT(log_step_uarch_until_halt, step_log_machine_fixture) {
    ...
    error_code = cm_get_root_hash(_machine, &hash1);
    BOOST_REQUIRE_EQUAL(error_code, CM_ERROR_OK);
    error_code = cm_verify_step_uarch(nullptr, &hash0, filename1.c_str(), 1, &hash1, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
    ...
    BOOST_REQUIRE_EQUAL(error_code, CM_ERROR_OK);
    error_code = cm_verify_step_uarch(nullptr, &hash1, filename2.c_str(), 1, &hash2, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
    ...
    BOOST_REQUIRE_EQUAL(error_code, CM_ERROR_OK);
    error_code = cm_verify_step_uarch(nullptr, &hash2, filename3.c_str(), 1, &hash3, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
    ...
    BOOST_REQUIRE_EQUAL(error_code, CM_ERROR_OK);
    error_code = cm_verify_step_uarch(_machine, &hash3, filename4.c_str(), 1, &hash4, nullptr);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
...
BOOST_FIXTURE_TEST_CASE_NOLINT(step_complex_test, step_log_machine_fixture) {
    ...
    cm_hash obtained_root_hash{};
    error_code = cm_verify_step_uarch(_machine, &hash0, filename.c_str(), 1, &hash1, &obtained_root_hash);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
    BOOST_CHECK_EQUAL(std::string(""), std::string(cm_get_last_error_message()));
    BOOST_CHECK_EQUAL_COLLECTIONS(obtained_root_hash, obtained_root_hash + sizeof(cm_hash), hash1,
        hash1 + sizeof(cm_hash));

    // verifying without root_hash_after still returns the obtained root hash
    cm_hash unchecked_root_hash{};
    error_code = cm_verify_step_uarch(_machine, &hash0, filename.c_str(), 1, nullptr, &unchecked_root_hash);
    BOOST_CHECK_EQUAL(error_code, CM_ERROR_OK);
    BOOST_CHECK_EQUAL_COLLECTIONS(unchecked_root_hash, unchecked_root_hash + sizeof(cm_hash), hash1,
        hash1 + sizeof(cm_hash));
}
