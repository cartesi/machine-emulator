...
local insns = {
    ...
    { bits = "_________________000_____0010011", name = "ADDI" },
    { bits = "_________________010_____0010011", name = "SLTI" },
    { bits = "_________________011_____0010011", name = "SLTIU" },
    { bits = "_________________100_____0010011", name = "XORI" },
    { bits = "_________________110_____0010011", name = "ORI" },
    { bits = "_________________111_____0010011", name = "ANDI" },
    { bits = "000000___________001_____0010011", name = "SLLI" },
    { bits = "000000___________101_____0010011", name = "SRLI" },
    { bits = "010000___________101_____0010011", name = "SRAI" },
    ...
    { bits = "_________________000_____0011011", name = "ADDIW" },
    { bits = "0000000__________001_____0011011", name = "SLLIW" },
    { bits = "0000000__________101_____0011011", name = "SRLIW" },
    { bits = "0100000__________101_____0011011", name = "SRAIW" },
